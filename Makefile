...
SOURCES := src/main.cpp src/tree.cpp src/diff_sup_func.cpp src/input_output_func.cpp src/main_func.cpp \
           src/eq_simpl.cpp src/menu.cpp src/err_func.cpp src/diff_calc_func.cpp src/expr_parsing.cpp\
